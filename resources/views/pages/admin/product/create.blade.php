...
@section('content')
    <div class="container tambah-product py-3">
        <div class="title d-flex align-items-center gap-2 pb-3">
            ...
            <h2 class="text-size text-opacity text-center my-0 fs-2">Tambah Product</h2>
        </div>

        <form action="{{ route('product.store') }}" method="POST" class="d-flex flex-column gap-2" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card bg-card pb-3">
                ...
                <div class="card-footer w-100">
                    <button type="submit" class="btn btn-primary float-end text-light fw-medium">Tambah Product</button>
                </div>
            </div>
        </form>
    </div>
